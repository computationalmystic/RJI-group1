...
echo "<p>mySQL connected successfully.<br/><p>";
        ...
        // Upload the file into the temp dir
            ...
            if (move_uploaded_file($tmpFilePath, $newFilePath)) {
                ...
                while(!preg_match('/[0-9]/', $technical)) {
                  //echo $filename;
		          sleep(1);
                  $technicaltmp=file_get_contents('http://localhost:8000/getScoreTechnicalAPI?NAME='.$filename);
                  $technical=substr($technicaltmp,-5,-1);
                } 
                echo "technical ". $technical . " / 10. ";
                ...
                while(!preg_match('/[0-9]/', $aesthetic)) {
		          //echo $filename;
		          sleep(1);
                  $aesthetictmp=file_get_contents('http://localhost:8000/getScoreAestheticAPI?NAME='.$filename);
                  $aesthetic=substr($aesthetictmp,-5,-1);
                }
